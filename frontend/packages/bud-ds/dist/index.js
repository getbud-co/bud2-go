  ...
  return /* @__PURE__ */ jsxs("div", { className: classes, ...rest, children: [
    /* @__PURE__ */ jsxs(
      "button",
      {
        type: "button",
        id: triggerId,
        className: s$E.trigger,
        "aria-expanded": isOpen,
        "aria-controls": panelId,
        disabled: disabled2,
        onClick: toggle,
        children: [
          Icon && /* @__PURE__ */ jsx(Icon, { size: 16, className: s$E.icon }),
          /* @__PURE__ */ jsxs("div", { className: s$E.triggerContent, children: [
            /* @__PURE__ */ jsx("span", { className: s$E.title, children: title2 }),
            description2 && /* @__PURE__ */ jsx("span", { className: s$E.description, children: description2 })
          ] }),
          action2 && /* @__PURE__ */ jsx("div", { className: s$E.action, children: action2 }),
          /* @__PURE__ */ jsx(CaretDown, { size: 16, className: s$E.caret })
        ]
      }
    ),
    /* @__PURE__ */ jsx(
      "div",
      {
        ...
        className: s$E.panel,
        inert: !isOpen || void 0,
        children: /* @__PURE__ */ jsx("div", { className: s$E.panelInner, children })
      }
    )
  ] });
}
function Accordion({ header: header2 = false, children, className, ...rest }) {
  const classes = [s$E.root, header2 ? s$E.rootHeader : "", className ?? ""].filter(Boolean).join(" ");
  ...
  ({
    ...
    return /* @__PURE__ */ jsxs("label", { className: wrapperClasses, children: [
      ...
      /* @__PURE__ */ jsx(
        "span",
        {
          className: `${s$D.box} ${s$D[size]}`,
          style: {
            width: boxSize$1[size],
            height: boxSize$1[size]
          },
          children: indeterminate ? /* @__PURE__ */ jsx(Minus, { size: iSize, className: s$D.icon }) : /* @__PURE__ */ jsx(Check, { size: iSize, className: s$D.icon })
        }
      ),
      label2 && /* @__PURE__ */ jsxs("span", { className: `${s$D.text} ${s$D[`text_${size}`]}`, children: [
        /* @__PURE__ */ jsx("span", { className: s$D.title, children: label2 }),
        description2 && /* @__PURE__ */ jsx("span", { className: s$D.description, children: description2 })
      ] })
    ] });
  }
);
...
function Popover({ items: items2, open: open2, onClose, anchorRef, ariaLabel }) {
  ...
  const getSubmenuFocusable = useCallback((wrapperEl) => {
    const submenu2 = wrapperEl.querySelector(`.${s$C.submenu}`);
    if (!submenu2) return [];
    return Array.from(
  ...
  const handlePopoverKeyDown = useCallback(
    (e) => {
      const activeWrapper = document.activeElement instanceof HTMLElement ? document.activeElement.closest(`.${s$C.submenuWrapper}`) : null;
      ...
      if (e.key === "ArrowLeft") {
        const activeSubmenu = document.activeElement instanceof HTMLElement ? document.activeElement.closest(`.${s$C.submenu}`) : null;
        if (activeSubmenu instanceof HTMLElement) {
          e.preventDefault();
          const wrapper2 = activeSubmenu.closest(`.${s$C.submenuWrapper}`);
  ...
  return createPortal(
    /* @__PURE__ */ jsx(
      ...
      {
        ref: popoverRef,
        className: s$C.popover,
        role: "menu",
        "aria-label": ariaLabel ?? "Popover",
        onKeyDown: handlePopoverKeyDown,
        children: items2.map((item2, index) => {
          const dividerEl = item2.divider ? /* @__PURE__ */ jsx("hr", { className: s$C.divider }) : null;
          if (item2.submenu) {
            return /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxs(
                "div",
                {
                  className: `${s$C.submenuWrapper}${submenuFlip2 ? ` ${s$C.submenuFlip}` : ""}${openSubmenuId === item2.id ? ` ${s$C.submenuWrapperOpen}` : ""}`,
                  ...
                  children: [
                    /* @__PURE__ */ jsxs(
                      "button",
                      {
                        ...
                        onClick: (e) => {
                          e.preventDefault();
                          const wrapper2 = e.currentTarget.closest(`.${s$C.submenuWrapper}`);
                        ...
                        children: [
                          item2.image ? /* @__PURE__ */ jsx("img", { src: item2.image, alt: "", className: s$C.itemImage }) : item2.icon ? /* @__PURE__ */ jsx(item2.icon, { size: 16, className: s$C.itemIcon }) : null,
                          /* @__PURE__ */ jsx("span", { className: s$C.itemLabel, children: item2.label }),
                          item2.badge != null && item2.badge > 0 && /* @__PURE__ */ jsx("span", { className: s$C.itemBadge, children: item2.badge }),
                          /* @__PURE__ */ jsx(CaretRight, { size: 12, className: s$C.itemCaret })
                        ]
                      }
                    ),
                    /* @__PURE__ */ jsx(
          ...
          return /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxs(
              ...
              {
                type: "button",
                className: `${s$C.item}${item2.danger ? ` ${s$C.itemDanger}` : ""}`,
                role: "menuitem",
                tabIndex: index === focusedIndex ? 0 : -1,
                onClick: () => {
                  item2.onClick?.();
...
const container$2 = "_container_1tvx9_2";
const header$7 = "_header_1tvx9_13";
const headerIcon$1 = "_headerIcon_1tvx9_20";
const title$9 = "_title_1tvx9_25";
const body$5 = "_body_1tvx9_37";
const symbol = "_symbol_1tvx9_47";
const budSymbol = "_budSymbol_1tvx9_51";
const heading = "_heading_1tvx9_57";
const suggestions = "_suggestions_1tvx9_69";
const suggestion = "_suggestion_1tvx9_69";
const messageList = "_messageList_1tvx9_104";
const userMessage = "_userMessage_1tvx9_114";
const userContext = "_userContext_1tvx9_133";
const userContextBadge = "_userContextBadge_1tvx9_140";
const userText$1 = "_userText_1tvx9_155";
const aiMessage = "_aiMessage_1tvx9_170";
const aiIcon = "_aiIcon_1tvx9_177";
const aiText = "_aiText_1tvx9_183";
const typingDots = "_typingDots_1tvx9_194";
const dot$3 = "_dot_1tvx9_201";
const cursor = "_cursor_1tvx9_227";
const inputArea = "_inputArea_1tvx9_247";
const inputGlow = "_inputGlow_1tvx9_252";
const inputBox$1 = "_inputBox_1tvx9_262";
const inputRow$1 = "_inputRow_1tvx9_274";
const input$5 = "_input_1tvx9_247";
const attachButton = "_attachButton_1tvx9_310";
const fileInput = "_fileInput_1tvx9_341";
const contextStrip = "_contextStrip_1tvx9_354";
const contextBadge = "_contextBadge_1tvx9_361";
const contextBadgeIcon = "_contextBadgeIcon_1tvx9_383";
const contextBadgeLabel = "_contextBadgeLabel_1tvx9_388";
const contextBadgeRemove = "_contextBadgeRemove_1tvx9_400";
const missionSearchBox = "_missionSearchBox_1tvx9_422";
const missionSearchIcon = "_missionSearchIcon_1tvx9_430";
const missionSearchInput = "_missionSearchInput_1tvx9_435";
const missionList = "_missionList_1tvx9_454";
const missionListItem = "_missionListItem_1tvx9_459";
const missionLabel = "_missionLabel_1tvx9_472";
const submitButton = "_submitButton_1tvx9_485";
const s$B = {
...
function AiAssistant({
  ...
  return /* @__PURE__ */ jsxs("div", { className: s$B.container, role: "region", "aria-label": title2, children: [
    /* @__PURE__ */ jsxs("div", { className: s$B.header, children: [
      /* @__PURE__ */ jsx(Lightning, { size: 16, className: s$B.headerIcon }),
      /* @__PURE__ */ jsx("h2", { className: s$B.title, children: title2 }),
    ...
    !hasMessages ? /* @__PURE__ */ jsxs("div", { className: s$B.body, children: [
      /* @__PURE__ */ jsx("div", { className: s$B.symbol, "aria-hidden": "true", children: /* @__PURE__ */ jsx(BudSymbol, {}) }),
      /* @__PURE__ */ jsx("p", { className: s$B.heading, children: heading2 }),
      suggestions2.length > 0 && /* @__PURE__ */ jsx("div", { className: s$B.suggestions, children: suggestions2.map((text2) => /* @__PURE__ */ jsxs(
        "button",
        {
          type: "button",
          className: s$B.suggestion,
          onClick: () => handleSuggestion(text2),
          children: [
            /* @__PURE__ */ jsx(Lightning, { size: 12, "aria-hidden": "true" }),
      ...
      "div",
      {
        className: s$B.messageList,
        ref: messageListRef,
        role: "log",
        "aria-live": "polite",
        children: [
          messages.map(
            (msg) => msg.role === "user" ? /* @__PURE__ */ jsxs("div", { className: s$B.userMessage, children: [
              msg.context && /* @__PURE__ */ jsxs("div", { className: s$B.userContext, children: [
                msg.context.fileCount > 0 && /* @__PURE__ */ jsxs("span", { className: s$B.userContextBadge, children: [
                  /* @__PURE__ */ jsx(File, { size: 10, "aria-hidden": "true" }),
                  msg.context.fileCount,
                  " ",
                  msg.context.fileCount === 1 ? "arquivo" : "arquivos"
                ] }),
                msg.context.missionCount > 0 && /* @__PURE__ */ jsxs("span", { className: s$B.userContextBadge, children: [
              ...
              /* @__PURE__ */ jsx("p", { className: s$B.userText, children: msg.content })
            ] }, msg.id) : /* @__PURE__ */ jsxs("div", { className: s$B.aiMessage, children: [
              /* @__PURE__ */ jsx(
                Lightning,
                {
                  size: 16,
                  className: s$B.aiIcon,
                  "aria-hidden": "true"
                }
              ),
              /* @__PURE__ */ jsx("p", { className: s$B.aiText, children: msg.content })
            ] }, msg.id)
          ),
          status === "thinking" && /* @__PURE__ */ jsxs(
            "div",
            {
              className: s$B.aiMessage,
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: s$B.typingDots, children: [
                  /* @__PURE__ */ jsx("span", { className: s$B.dot }),
                  /* @__PURE__ */ jsx("span", { className: s$B.dot }),
                  /* @__PURE__ */ jsx("span", { className: s$B.dot })
                ] })
              ]
          ...
          status === "streaming" && /* @__PURE__ */ jsxs("div", { className: s$B.aiMessage, children: [
            /* @__PURE__ */ jsx(
              Lightning,
              {
                size: 16,
            ...
            /* @__PURE__ */ jsxs("p", { className: s$B.aiText, children: [
              streamingText,
              /* @__PURE__ */ jsx("span", { className: s$B.cursor, "aria-hidden": "true" })
            ] })
          ] })
        ]
      }
    ),
    /* @__PURE__ */ jsxs("form", { className: s$B.inputArea, onSubmit: handleSubmit, children: [
      /* @__PURE__ */ jsx("div", { className: s$B.inputGlow, "aria-hidden": "true" }),
      allowUpload && /* @__PURE__ */ jsx(
        "input",
        {
          ...
          type: "file",
          multiple: true,
          className: s$B.fileInput,
          onChange: handleFileChange,
          tabIndex: -1
        }
      ),
      /* @__PURE__ */ jsxs("div", { className: s$B.inputBox, children: [
        hasContext && /* @__PURE__ */ jsxs("div", { className: s$B.contextStrip, children: [
          attachedFiles.length > 0 && /* @__PURE__ */ jsxs("span", { className: s$B.contextBadge, children: [
            /* @__PURE__ */ jsx(File, { size: 12, className: s$B.contextBadgeIcon }),
            /* @__PURE__ */ jsxs("span", { className: s$B.contextBadgeLabel, children: [
            ...
            /* @__PURE__ */ jsx(
              ...
              {
                type: "button",
                className: s$B.contextBadgeRemove,
          ...
          selectedMissionCount > 0 && /* @__PURE__ */ jsxs("span", { className: s$B.contextBadge, children: [
            /* @__PURE__ */ jsx(Link, { size: 12, className: s$B.contextBadgeIcon }),
            /* @__PURE__ */ jsxs("span", { className: s$B.contextBadgeLabel, children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: s$B.inputRow, children: [
          /* @__PURE__ */ jsx(
            "input",
            {
              className: s$B.input,
                  ...
                  if (missions && missions.length > 0) {
                    menuItems.push({
                      ...
                      submenu: /* @__PURE__ */ jsxs(Fragment, { children: [
                        /* @__PURE__ */ jsxs("div", { className: s$B.missionSearchBox, children: [
                          /* @__PURE__ */ jsx(
                            MagnifyingGlass,
                            {
                              size: 14,
                              className: s$B.missionSearchIcon
                            }
                          ),
                          /* @__PURE__ */ jsx(
                            "input",
                            {
                              className: s$B.missionSearchInput,
                              value: missionSearch,
                        ...
                        /* @__PURE__ */ jsx("div", { className: s$B.missionList, children: filteredMissions?.map((m) => /* @__PURE__ */ jsxs("label", { className: s$B.missionListItem, children: [
                          /* @__PURE__ */ jsx(
                            Checkbox,
                            {
                              size: "sm",
                          ...
                          /* @__PURE__ */ jsx("span", { className: s$B.missionLabel, children: m.label })
                        ] }, m.id)) })
                      ] })
                    });
                  }
...
function BudSymbol() {
  return /* @__PURE__ */ jsx("svg", { viewBox: "0 0 240 92", fill: "none", className: s$B.budSymbol, children: /* @__PURE__ */ jsx(
    "path",
    {
...
function Alert({
  ...
  const classes = [s$A.alert, s$A[variant], className ?? ""].filter(Boolean).join(" ");
  return /* @__PURE__ */ jsxs("div", { className: classes, role: "alert", ...rest, children: [
    /* @__PURE__ */ jsx("span", { className: s$A.icon, children: /* @__PURE__ */ jsx(Icon, { size: 20, "aria-hidden": true }) }),
    /* @__PURE__ */ jsxs("div", { className: s$A.content, children: [
      /* @__PURE__ */ jsx("p", { className: s$A.title, children: title2 }),
      children && /* @__PURE__ */ jsx("div", { className: s$A.description, children }),
      action2 && /* @__PURE__ */ jsx(
        "button",
        {
          type: "button",
          className: s$A.action,
...
function Avatar({
  ...
  const classes = [
    s$z.avatar,
    sizeClass$2[size],
    isInitials ? s$z.hasInitials : "",
    !isImage && !isInitials ? s$z.placeholder : "",
    className ?? ""
  ].filter(Boolean).join(" ");
  return /* @__PURE__ */ jsxs("span", { className: classes, children: [
    isImage && /* @__PURE__ */ jsx("img", { className: s$z.image, src, alt }),
    isInitials && /* @__PURE__ */ jsx("span", { className: s$z.initials, children: initials2 }),
    !isImage && !isInitials && /* @__PURE__ */ jsx(User, { size: iconSize$2[size], className: s$z.placeholderIcon }),
    online2 && !companyLogo && /* @__PURE__ */ jsx("span", { className: s$z.online }),
    companyLogo && /* @__PURE__ */ jsx("span", { className: s$z.company, children: /* @__PURE__ */ jsx("img", { src: companyLogo, alt: "" }) })
  ] });
}
...
function AvatarGroup({
  ...
  const classes = [
    s$y.group,
    sizeClass$1[size],
    showAddButton ? hasMore ? s$y.gapMore : s$y.gapAdd : "",
    className ?? ""
  ].filter(Boolean).join(" ");
  return /* @__PURE__ */ jsxs("div", { className: classes, children: [
    /* @__PURE__ */ jsxs("div", { className: s$y.stack, children: [
      visible.map((avatar2, i) => /* @__PURE__ */ jsx(
        Avatar,
        {
          ...
          alt: avatar2.alt,
          className: s$y.stackItem
        },
        i
      )),
      hasMore && /* @__PURE__ */ jsx("span", { className: s$y.more, children: /* @__PURE__ */ jsxs("span", { className: s$y.moreText, children: [
        "+",
        remaining
      ] }) })
    ] }),
    showAddButton && /* @__PURE__ */ jsx(
      ...
      {
        type: "button",
        className: s$y.addButton,
        onClick: onAddClick,
        "aria-label": "Adicionar usuário",
        children: /* @__PURE__ */ jsx(Plus, { size: 16, className: s$y.addIcon })
      }
    )
  ] });
}
...
function AvatarLabelGroup({
  ...
  const classes = [s$x.group, sizeClass[size], className ?? ""].filter(Boolean).join(" ");
  return /* @__PURE__ */ jsxs("div", { className: classes, children: [
    /* @__PURE__ */ jsx(
      Avatar,
      {
    ...
    /* @__PURE__ */ jsxs("div", { className: s$x.text, children: [
      /* @__PURE__ */ jsx("span", { className: s$x.name, children: name2 }),
      supportingText && /* @__PURE__ */ jsx("span", { className: s$x.supporting, children: supportingText })
    ] })
  ] });
}
  ...
  return /* @__PURE__ */ jsx(
    "span",
    {
      ...
      children: isIconOnly ? Icon && /* @__PURE__ */ jsx(Icon, { size: iconSize$1[size], "aria-hidden": true }) : /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        children && /* @__PURE__ */ jsx("span", { className: s$w.label, children }),
...
function Breadcrumb({ items: items2, current = 0 }) {
  return /* @__PURE__ */ jsx("nav", { className: s$v.breadcrumb, "aria-label": "Breadcrumb", children: /* @__PURE__ */ jsx("ol", { className: s$v.list, children: items2.map((item2, i) => {
    const isPast = i < current;
    const isCurrent = i === current;
    const isLast = i === items2.length - 1;
    const itemClass = [
      s$v.item,
      isPast || isCurrent ? s$v.itemCompleted : ""
    ].filter(Boolean).join(" ");
    return /* @__PURE__ */ jsxs("li", { className: s$v.step, children: [
      isPast && item2.href ? /* @__PURE__ */ jsx("a", { href: item2.href, className: itemClass, children: item2.label }) : isPast && item2.onClick ? /* @__PURE__ */ jsx(
        ...
        {
          type: "button",
          className: `${itemClass} ${s$v.clickable}`,
...
function Card({
  ...
  const classes = [
    s$u.card,
    padding !== "none" ? s$u[`padding-${padding}`] : "",
    shadow2 ? s$u.shadow : "",
    className ?? ""
  ].filter(Boolean).join(" ");
  return /* @__PURE__ */ jsx("div", { className: classes, ...rest, children });
...
function CardHeader({
  ...
  const classes = [s$u.header, className ?? ""].filter(Boolean).join(" ");
  return /* @__PURE__ */ jsxs("div", { className: classes, ...rest, children: [
    /* @__PURE__ */ jsxs("div", { className: s$u.headerText, children: [
      /* @__PURE__ */ jsx("h3", { className: s$u.title, children: title2 }),
      description2 && /* @__PURE__ */ jsx("p", { className: s$u.description, children: description2 })
    ] }),
    action2 && /* @__PURE__ */ jsx("div", { className: s$u.headerAction, children: action2 })
  ] });
}
function CardBody({ children, className, ...rest }) {
  const classes = [s$u.body, className ?? ""].filter(Boolean).join(" ");
  return /* @__PURE__ */ jsx("div", { className: classes, ...rest, children });
}
function CardFooter({ children, className, ...rest }) {
  const classes = [s$u.footer, className ?? ""].filter(Boolean).join(" ");
  return /* @__PURE__ */ jsx("div", { className: classes, ...rest, children });
}
function CardDivider() {
  return /* @__PURE__ */ jsx("hr", { className: s$u.divider });
}
...
function Chart({ value: value2, variant = "full", size = 40, className }) {
  ...
  if (variant === "half") {
    ...
    return /* @__PURE__ */ jsxs(
      "svg",
      {
        className: `${s$t.halfChart} ${className ?? ""}`,
        style: vars,
        viewBox: "0 0 40 22",
        role: "img",
        "aria-label": `${clamped}%`,
        children: [
          ...
          clamped > 0 && /* @__PURE__ */ jsx(
            ...
            {
              d: "M 2,20 A 18,18 0 0,1 38,20",
              className: s$t.halfProgress,
              strokeDasharray: HALF_CIRCUMFERENCE,
              strokeDashoffset: offset2
            }
          ),
          /* @__PURE__ */ jsxs("text", { x: "20", y: "20", textAnchor: "middle", className: s$t.halfText, children: [
            /* @__PURE__ */ jsx("tspan", { className: s$t.halfValue, children: clamped }),
            /* @__PURE__ */ jsx("tspan", { className: s$t.halfPercent, children: "%" })
          ] })
        ]
      }
    );
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      className: `${s$t.chart} ${className ?? ""}`,
      style: vars,
      role: "img",
      "aria-label": `${clamped}%`,
      children: [
        /* @__PURE__ */ jsxs("svg", { className: s$t.ring, viewBox: "0 0 40 40", "aria-hidden": "true", children: [
          /* @__PURE__ */ jsx("circle", { cx: "20", cy: "20", r: RADIUS, className: s$t.track }),
          clamped > 0 && /* @__PURE__ */ jsx(
            "circle",
            {
              cx: "20",
              cy: "20",
              r: RADIUS,
              className: s$t.progress,
              strokeDasharray: FULL_CIRCUMFERENCE,
              strokeDashoffset: offset
            }
          )
        ] }),
        /* @__PURE__ */ jsxs("span", { className: s$t.textGroup, children: [
          /* @__PURE__ */ jsx("span", { className: s$t.value, children: clamped }),
          /* @__PURE__ */ jsx("span", { className: s$t.percent, children: "%" })
        ] })
      ]
    }
  );
...
function ChartTooltipContent({
  ...
  return /* @__PURE__ */ jsxs("div", { className: s$s.tooltip, children: [
    formattedLabel && /* @__PURE__ */ jsx("p", { className: s$s.label, children: formattedLabel }),
    /* @__PURE__ */ jsx("div", { className: s$s.items, children: payload.map((entry, i) => /* @__PURE__ */ jsxs("div", { className: s$s.item, children: [
      /* @__PURE__ */ jsx(
        "span",
        {
          className: s$s.dot,
      ...
      /* @__PURE__ */ jsx("span", { className: s$s.name, children: entry.name }),
      /* @__PURE__ */ jsx("span", { className: s$s.value, children: valueFormatter ? valueFormatter(entry.value ?? 0) : entry.value?.toLocaleString("pt-BR") })
    ] }, i)) })
  ] });
}
    ...
    ChoiceBoxContext.Provider,
    {
      ...
      children: /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          "aria-label": label2,
          children: [
            label2 && /* @__PURE__ */ jsx("span", { className: s$r.groupLabel, children: label2 }),
            /* @__PURE__ */ jsx("div", { className: s$r.groupGrid, children })
          ]
        }
      )
    }
...
function ChoiceBox({
  ...
  const cardClasses = [s$r.card, isDisabled2 ? s$r.disabled : "", className ?? ""].filter(Boolean).join(" ");
  ...
  return /* @__PURE__ */ jsxs("label", { className: cardClasses, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: s$r.cardContent, children: [
      ctx.multiple ? /* @__PURE__ */ jsx("span", { className: s$r.checkbox, children: /* @__PURE__ */ jsx(Check, { size: 12, className: s$r.checkIcon }) }) : /* @__PURE__ */ jsx("span", { className: s$r.radio, children: /* @__PURE__ */ jsx("span", { className: s$r.radioDot }) }),
      /* @__PURE__ */ jsxs("div", { className: s$r.text, children: [
        /* @__PURE__ */ jsx("span", { className: s$r.title, children: title2 }),
        description2 && /* @__PURE__ */ jsx("span", { className: s$r.description, children: description2 })
      ] })
    ] }),
    link2 && /* @__PURE__ */ jsx("div", { className: s$r.linkRow, children: /* @__PURE__ */ jsx(
      "a",
      {
        className: s$r.link,
        href: link2.href,
...
function DatePicker(props) {
  ...
  const wrapperClasses = [s$q.wrapper, className ?? ""].filter(Boolean).join(" ");
  const triggerClasses = [
    s$q.trigger,
    s$q[size],
    isError ? s$q.error : "",
    disabled2 ? s$q.disabled : "",
    open2 ? s$q.open : ""
  ].filter(Boolean).join(" ");
  ...
  const getDayClasses = (cell2) => {
    const d = cell2.date;
    const classes = [s$q.day];
    if (!cell2.isCurrentMonth) classes.push(s$q.dayOtherMonth);
    if (isDisabled(d, minDate, maxDate)) classes.push(s$q.dayDisabled);
    if (isToday(d)) classes.push(s$q.dayToday);
    if (isRange) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: wrapperClasses, ref: wrapperRef, children: [
    label2 && /* @__PURE__ */ jsx("label", { className: s$q.label, htmlFor: isRange ? startInputId : triggerId, children: label2 }),
    /* @__PURE__ */ jsx("div", { className: s$q.anchor, children: isRange ? (
          ...
          children: [
            ...
            /* @__PURE__ */ jsx(
              "input",
              {
                ...
                id: startInputId,
                type: "text",
                className: s$q.rangeTriggerInput,
            ...
            /* @__PURE__ */ jsx("span", { className: s$q.rangeSeparator, children: "→" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                ref: endInputRef,
            ...
            /* @__PURE__ */ jsx(
              ...
              {
                size: iconSize2,
                className: `${s$q.caret} ${open2 ? s$q.caretOpen : ""}`
              }
            )
          ]
        }
      ...
      /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsx(CalendarBlank, { size: iconSize2 }),
            /* @__PURE__ */ jsx("span", { className: triggerText ? s$q.value : s$q.placeholder, children: triggerText ?? placeholder2 ?? defaultPlaceholder }),
            /* @__PURE__ */ jsx(
              CaretDown,
              {
                size: iconSize2,
    ...
    open2 && createPortal(
      /* @__PURE__ */ jsxs(
        ...
        {
          ref: popoverRef,
          className: s$q.popover,
          style: popoverStyle,
          role: "dialog",
          "aria-label": "Seletor de data",
          onMouseDown: (e) => e.preventDefault(),
          children: [
            !isRange && /* @__PURE__ */ jsx("div", { className: s$q.popoverHeader, children: /* @__PURE__ */ jsx(
              "input",
              {
                ref: startInputRef,
                type: "text",
                className: s$q.headerInput,
                placeholder: "DD/MM/AAAA",
                value: startText,
                onChange: handleStartTextChange,
                onKeyDown: handleInputKeyDown,
            ...
            /* @__PURE__ */ jsxs("div", { className: s$q.calendarNav, children: [
              /* @__PURE__ */ jsx(
                Button,
                {
                  variant: "tertiary",
              ...
              /* @__PURE__ */ jsxs("span", { className: s$q.monthYear, "aria-live": "polite", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: s$q.weekdays, children: WEEKDAY_LABELS.map((wd) => /* @__PURE__ */ jsx("div", { className: s$q.weekday, children: wd }, wd)) }),
            /* @__PURE__ */ jsx(
              "div",
              {
                className: s$q.grid,
            ...
            /* @__PURE__ */ jsx("div", { className: s$q.popoverFooter, children: /* @__PURE__ */ jsx(
              Button,
              {
                variant: "tertiary",
                size: "sm",
                className: s$q.todayBtn,
                onClick: handleToday,
                children: "Hoje"
              }
            ) })
    ...
    hasMessage && /* @__PURE__ */ jsxs("div", { id: messageId, className: `${s$q.message} ${s$q[messageType]}`, children: [
...
const label$8 = "_label_14a29_118";
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          LeftIcon && /* @__PURE__ */ jsx(LeftIcon, { size: iSize }),
          /* @__PURE__ */ jsx("span", { className: s$p.label, children }),
          /* @__PURE__ */ jsx(CaretDown, { size: iSize, className: `${s$p.caret} ${open2 ? s$p.caretOpen : ""}` })
        ]
      }
    ),
    open2 && createPortal(
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          onKeyDown: handleKeyDown,
          children: [
            searchable && /* @__PURE__ */ jsxs("div", { className: s$p.searchWrapper, children: [
              /* @__PURE__ */ jsx(MagnifyingGlass, { size: 14, className: s$p.searchIcon }),
              /* @__PURE__ */ jsx(
                "input",
                {
                  ref: searchRef,
                  className: s$p.searchInput,
                  type: "text",
                  role: "combobox",
                  "aria-expanded": "true",
                  "aria-haspopup": "menu",
            ...
            /* @__PURE__ */ jsxs("ul", { ref: listRef, id: listId, className: s$p.list, role: "presentation", children: [
              filtered.map((item2, i) => /* @__PURE__ */ jsxs(
                "li",
                {
                  id: `${triggerId}-opt-${i}`,
                  className: `${s$p.item} ${i === focusedIndex ? s$p.focused : ""}`,
                  role: "menuitem",
                  onMouseEnter: () => setFocusedIndex(i),
                  onClick: () => handleSelect(item2),
                  children: [
                    item2.icon && /* @__PURE__ */ jsx(item2.icon, { size: 16, className: s$p.itemIcon }),
                    /* @__PURE__ */ jsxs("div", { className: s$p.itemText, children: [
                      /* @__PURE__ */ jsx("span", { className: s$p.itemLabel, children: item2.label }),
                      item2.description && /* @__PURE__ */ jsx("span", { className: s$p.itemDescription, children: item2.description })
                    ] })
                  ]
                },
                item2.id
              )),
              filtered.length === 0 && /* @__PURE__ */ jsx("li", { className: s$p.empty, role: "presentation", children: "Nenhum resultado encontrado" })
            ] })
          ]
        }
      ),
...
function FilterChip({
  ...
  const chipClasses = [
    s$o.chip,
    active2 ? s$o.chipActive : "",
    onClick ? "" : s$o.chipStatic,
    className ?? ""
  ].filter(Boolean).join(" ");
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        Icon && /* @__PURE__ */ jsx(Icon, { size: 14, className: s$o.chipIcon }),
        /* @__PURE__ */ jsx("span", { className: s$o.chipLabel, children: label2 }),
        onRemove && /* @__PURE__ */ jsx(
          "button",
          {
            type: "button",
            className: s$o.chipRemove,
            onClick: (e) => {
              e.stopPropagation();
              onRemove();
            },
...
function FilterDropdown({
  ...
  if (!open2) return null;
  const classes = [s$o.dropdown, className ?? ""].filter(Boolean).join(" ");
  return createPortal(
    /* @__PURE__ */ jsxs(Fragment, { children: [
      !noOverlay && /* @__PURE__ */ jsx("div", { className: s$o.overlay, role: "presentation", onClick: onClose }),
      /* @__PURE__ */ jsxs(
        "div",
        {
          ref: dropdownRef,
          ...
          children: [
            /* @__PURE__ */ jsx("div", { className: s$o.sheetHandle }),
            children
          ]
        }
      )
...
function FilterBar({
  ...
  const barClasses = [s$o.bar, className ?? ""].filter(Boolean).join(" ");
  const triggerClasses = [s$o.addTrigger, open2 ? s$o.addOpen : ""].filter(Boolean).join(" ");
  return /* @__PURE__ */ jsxs("div", { className: barClasses, children: [
    /* @__PURE__ */ jsxs("div", { className: s$o.filters, children: [
      /* @__PURE__ */ jsxs(
        "button",
        {
          ref: triggerRef,
      ...
      open2 && createPortal(
        /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx("div", { className: s$o.overlay, role: "presentation", onClick: closePopover }),
          /* @__PURE__ */ jsxs(
            "div",
            {
              ref: popoverRef,
              className: s$o.addPopover,
              onMouseDown: (e) => e.preventDefault(),
              children: [
                /* @__PURE__ */ jsx("div", { className: s$o.sheetHandle }),
                /* @__PURE__ */ jsxs("div", { className: s$o.addSearchBox, children: [
                  /* @__PURE__ */ jsx(MagnifyingGlass, { size: 14, className: s$o.addSearchIcon }),
                  /* @__PURE__ */ jsx(
                    "input",
                    {
                      ref: searchRef,
                      type: "text",
                      className: s$o.addSearchInput,
                      placeholder: searchPlaceholder,
                      value: search,
                  ...
                  "div",
                  {
                    ...
                    children: [
                      filtered.map((f, i) => /* @__PURE__ */ jsxs(
                        ...
                        {
                          id: getOptionId(i),
                          className: `${s$o.addItem} ${i === focusedIndex ? s$o.addItemFocused : ""}`,
                          role: "option",
                          "aria-selected": i === focusedIndex,
                          onMouseEnter: () => setFocusedIndex(i),
                          onClick: () => handleSelectFilter(f.id),
                          children: [
                            f.icon && /* @__PURE__ */ jsx(f.icon, { size: 16, className: s$o.addItemIcon }),
                            /* @__PURE__ */ jsx("span", { children: f.label })
                          ]
                        },
                        f.id
                      )),
                      filtered.length === 0 && /* @__PURE__ */ jsx("div", { className: s$o.addEmpty, role: "presentation", children: "Nenhum filtro encontrado" })
                    ]
                  }
                )
              ]
    ...
    hasChildren && (onClearAll || onSaveView || primaryAction) && /* @__PURE__ */ jsxs("div", { className: s$o.actions, children: [
      onClearAll && /* @__PURE__ */ jsxs(
        "button",
        {
          type: "button",
          className: s$o.actionBtn,
          onClick: onClearAll,
          "aria-label": "Limpar filtros",
          children: [
            /* @__PURE__ */ jsx(Broom, { size: 14 }),
            /* @__PURE__ */ jsx("span", { className: s$o.actionLabel, children: "Limpar filtros" })
          ]
        }
      ),
      onSaveView && /* @__PURE__ */ jsxs(Fragment, { children: [
        onClearAll && /* @__PURE__ */ jsx("span", { className: s$o.separator }),
        /* @__PURE__ */ jsxs(
          "button",
          {
            type: "button",
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("span", { className: s$o.actionLabel, children: saveViewLabel })
            ]
          }
        )
      ] }),
...
function Funnel({
  ...
  return /* @__PURE__ */ jsx("div", { className: [s$n.root, className].filter(Boolean).join(" "), children: /* @__PURE__ */ jsx(
    "svg",
    {
      role: "img",
      ...
      children: data.map((step2, i) => {
        ...
        return /* @__PURE__ */ jsxs(
          "g",
          {
            className: `${s$n.step}${isDimmed ? ` ${s$n.stepDimmed}` : ""}${isHovered ? ` ${s$n.stepHovered}` : ""}`,
...
const STATUS_CLASS = {
  "on-track": s$m.onTrack,
  attention: s$m.attention,
  "off-track": s$m.offTrack
};
...
function GoalProgressBar({
  ...
  return /* @__PURE__ */ jsxs("div", { className: `${s$m.wrapper} ${STATUS_CLASS[status]} ${className ?? ""}`, children: [
    /* @__PURE__ */ jsx("span", { className: s$m.label, children: label2 }),
    /* @__PURE__ */ jsxs(
      "div",
      {
        className: `${s$m.trackContainer} ${interactive2 ? s$m.interactive : ""} ${dragging2 ? s$m.dragging : ""}`,
        ref: trackRef,
        ...
        children: [
          /* @__PURE__ */ jsx(
            "div",
            {
              ...
              "aria-label": label2,
              children: /* @__PURE__ */ jsx("div", { className: s$m.fill, style: { width: `${percent2}%` } })
            }
          ),
          expected !== void 0 && /* @__PURE__ */ jsx(
            "div",
            {
              className: s$m.expectedMarker,
    ...
    /* @__PURE__ */ jsxs("div", { className: s$m.footer, children: [
      /* @__PURE__ */ jsxs("span", { className: s$m.statusGroup, children: [
        /* @__PURE__ */ jsx("span", { className: s$m.statusDot }),
        /* @__PURE__ */ jsx("span", { className: s$m.statusText, children: STATUS_LABELS[status] })
      ] }),
      /* @__PURE__ */ jsx("span", { className: s$m.valueText, children: display })
    ] })
  ] });
}
...
function GoalGaugeBar({
  ...
  return /* @__PURE__ */ jsxs("div", { className: `${s$m.wrapper} ${STATUS_CLASS[status]} ${className ?? ""}`, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: s$m.footer, children: [
      /* @__PURE__ */ jsxs("span", { className: s$m.statusGroup, children: [
        /* @__PURE__ */ jsx("span", { className: s$m.statusDot }),
        /* @__PURE__ */ jsx("span", { className: s$m.statusText, children: GAUGE_STATUS_LABELS[status] })
      ] }),
      /* @__PURE__ */ jsx("span", { className: s$m.valueText, children: display })
    ] })
  ] });
...
function Heatmap({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(
      ...
      {
        ref: rootRef,
        className: `${s$l.root} ${className ?? ""}`,
        style: vars,
        role: "table",
        "aria-label": "Mapa de calor",
        children: [
          /* @__PURE__ */ jsxs("div", { className: s$l.headerRow, role: "row", children: [
            /* @__PURE__ */ jsx("span", { className: s$l.cornerCell, role: "columnheader" }),
            columns.map((col) => /* @__PURE__ */ jsx(
              "span",
              {
                className: s$l.colLabel,
                role: "columnheader",
          ...
          rows.map((row2) => /* @__PURE__ */ jsxs("div", { className: s$l.dataRow, role: "row", children: [
            /* @__PURE__ */ jsx("span", { className: s$l.rowLabel, role: "rowheader", title: row2, children: row2 }),
            columns.map((col) => {
              ...
              const hoverClass = hoveredCell ? isExact ? s$l.cellActive : isRowOrCol ? s$l.cellHighlight : s$l.cellDimmed : "";
              return /* @__PURE__ */ jsx(
                "span",
                {
                  className: `${s$l.cell} ${hoverClass}`,
                  style: hasValue ? {
          ...
          /* @__PURE__ */ jsxs("div", { className: s$l.legend, "aria-hidden": "true", children: [
            /* @__PURE__ */ jsx("span", { className: s$l.legendLabel, children: "Menor" }),
            STEPS.map((step2) => /* @__PURE__ */ jsx(
              "span",
              {
                className: s$l.legendCell,
                style: { backgroundColor: `var(${prefix}-${step2})` }
              },
              step2
            )),
            /* @__PURE__ */ jsx("span", { className: s$l.legendLabel, children: "Maior" })
          ] })
        ]
      }
    ),
    tooltip2 && createPortal(
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          "aria-hidden": "true",
          children: [
            /* @__PURE__ */ jsx("span", { className: s$l.tooltipRow, children: tooltip2.row }),
            /* @__PURE__ */ jsx("span", { className: s$l.tooltipCol, children: colTooltipLabel(tooltip2.col) }),
            /* @__PURE__ */ jsx("span", { className: s$l.tooltipValue, children: format(tooltip2.value) })
          ]
        }
      ),
      document.body
...
function NotificationPanel({
  ...
  if (!open2) return null;
  const classes = [s$k.panel, className ?? ""].filter(Boolean).join(" ");
  return createPortal(
    /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx("div", { className: s$k.overlay, role: "presentation", onClick: onClose }),
      /* @__PURE__ */ jsxs(
        "div",
        {
          ref: panelRef,
          ...
          onMouseDown: (e) => e.preventDefault(),
          children: [
            /* @__PURE__ */ jsx("div", { className: s$k.sheetHandle }),
            /* @__PURE__ */ jsxs("div", { className: s$k.header, children: [
              /* @__PURE__ */ jsx("span", { className: s$k.headerTitle, children: title2 }),
              hasUnread && onMarkAllRead && /* @__PURE__ */ jsx(
                "button",
                {
                  type: "button",
                  className: s$k.markAllBtn,
                  onClick: onMarkAllRead,
                  children: "Marcar todas como lidas"
                }
              )
            ] }),
            /* @__PURE__ */ jsx("div", { className: s$k.list, children: notifications.length === 0 ? /* @__PURE__ */ jsxs("div", { className: s$k.empty, children: [
              /* @__PURE__ */ jsx(BellSlash, { size: 32, className: s$k.emptyIcon }),
              /* @__PURE__ */ jsx("span", { className: s$k.emptyText, children: emptyMessage })
            ] }) : notifications.map((n) => /* @__PURE__ */ jsxs(
              "button",
              {
                type: "button",
                className: `${s$k.item} ${n.unread ? s$k.itemUnread : ""}`,
                ...
                children: [
                  n.avatarUrl ? /* @__PURE__ */ jsx(
                    "img",
                    {
                      src: n.avatarUrl,
                      alt: "",
                      className: s$k.itemAvatar
                    }
                  ) : n.icon ? /* @__PURE__ */ jsx("div", { className: s$k.itemAvatar, children: /* @__PURE__ */ jsx(n.icon, { size: 16 }) }) : /* @__PURE__ */ jsx("div", { className: s$k.itemAvatar }),
                  /* @__PURE__ */ jsxs("div", { className: s$k.itemContent, children: [
                    /* @__PURE__ */ jsx("span", { className: s$k.itemTitle, children: n.title }),
                    n.description && /* @__PURE__ */ jsx("span", { className: s$k.itemDesc, children: n.description }),
                    /* @__PURE__ */ jsx("span", { className: s$k.itemTime, children: n.time })
                  ] }),
                  n.unread ? /* @__PURE__ */ jsx("span", { className: s$k.itemDot, "aria-label": "Não lida" }) : /* @__PURE__ */ jsx("span", { className: s$k.itemDotPlaceholder })
                ]
              },
              n.id
            )) }),
            onViewAll && notifications.length > 0 && /* @__PURE__ */ jsx("div", { className: s$k.footer, children: /* @__PURE__ */ jsx(
              "button",
              {
                type: "button",
                className: s$k.footerBtn,
                onClick: onViewAll,
...
const NotificationButton = forwardRef(function NotificationButton2({ hasUnread = false, className, ...rest }, ref) {
  return /* @__PURE__ */ jsxs("span", { className: s$j.notificationWrapper, children: [
    /* @__PURE__ */ jsx(
      Button,
      {
        ref,
    ...
    hasUnread && /* @__PURE__ */ jsx("span", { className: s$j.badge, "aria-hidden": "true" })
  ] });
});
const AssistantButton = forwardRef(function AssistantButton2({ label: label2 = "Assistente", active: active2 = false, className, ...rest }, ref) {
  ...
  return /* @__PURE__ */ jsx(
    Button,
    {
      ...
      className: classes,
      ...rest,
      children: /* @__PURE__ */ jsx("span", { className: s$j.assistantLabel, children: label2 })
    },
...
function PageHeader({
  ...
  const classes = [s$j.header, className ?? ""].filter(Boolean).join(" ");
  return /* @__PURE__ */ jsxs("header", { className: classes, children: [
    /* @__PURE__ */ jsx("h1", { className: s$j.title, children: title2 }),
    children && /* @__PURE__ */ jsx("div", { className: s$j.actions, children })
  ] });
}
...
function CommandPalette({
  ...
  return createPortal(
    /* @__PURE__ */ jsx(
      "div",
      {
        className: s$i.overlay,
        role: "presentation",
        onMouseDown: (e) => {
          if (e.target === e.currentTarget) onClose();
        },
        onKeyDown: handleKeyDown,
        children: /* @__PURE__ */ jsxs("div", { className: s$i.container, ref: containerRef, role: "dialog", "aria-modal": "true", "aria-label": "Busca", children: [
          /* @__PURE__ */ jsxs("div", { className: s$i.inputRow, children: [
            /* @__PURE__ */ jsx(MagnifyingGlass, { size: 16, className: s$i.inputIcon }),
            /* @__PURE__ */ jsx(
              "input",
              {
                ref: inputRef,
          ...
          /* @__PURE__ */ jsx("div", { className: s$i.list, ref: listRef, id: listboxId, role: "listbox", children: flatItems.length === 0 ? /* @__PURE__ */ jsx("div", { className: s$i.empty, children: emptyMessage }) : renderGroups.map((g) => /* @__PURE__ */ jsxs("div", { children: [
            g.label && /* @__PURE__ */ jsx("div", { className: s$i.groupLabel, children: g.label }),
            g.items.map(({ item: item2, flatIdx }) => /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                className: `${s$i.item} ${flatIdx === selectedIndex ? s$i.itemSelected : ""}`,
                onMouseEnter: () => setSelectedIndex(flatIdx),
                onClick: () => onSelect(item2.id),
                children: [
                  item2.icon && /* @__PURE__ */ jsx(item2.icon, { size: 16, className: s$i.itemIcon }),
                  /* @__PURE__ */ jsx("span", { children: item2.label }),
                  item2.hint && /* @__PURE__ */ jsx("span", { className: s$i.itemHint, children: item2.hint })
                ]
              },
              item2.id
            ))
          ] }, g.label)) }),
          footer2 !== void 0 ? footer2 : /* @__PURE__ */ jsxs("div", { className: s$i.footer, children: [
            /* @__PURE__ */ jsxs("span", { children: [
              /* @__PURE__ */ jsx("kbd", { className: s$i.kbd, children: "↑" }),
              " ",
              /* @__PURE__ */ jsx("kbd", { className: s$i.kbd, children: "↓" }),
              " ",
              "navegar"
            ...
            /* @__PURE__ */ jsxs("span", { children: [
              /* @__PURE__ */ jsx("kbd", { className: s$i.kbd, children: "esc" }),
              " fechar"
            ] })
          ] })
        ] })
...
const Input = forwardRef(
  ({
    ...
    const wrapperClasses = [s$h.wrapper, className ?? ""].filter(Boolean).join(" ");
    const inputBoxClasses = [
      s$h.inputBox,
      s$h[size],
      isError ? s$h.error : "",
      disabled2 ? s$h.disabled : ""
    ].filter(Boolean).join(" ");
    const MsgIcon = messageType ? messageIconMap$2[messageType] : null;
    return /* @__PURE__ */ jsxs("div", { className: wrapperClasses, children: [
      label2 && /* @__PURE__ */ jsx("label", { className: s$h.label, htmlFor: inputId, children: label2 }),
      ...
      hasMessage && /* @__PURE__ */ jsxs("div", { id: messageId, className: `${s$h.message} ${s$h[messageType]}`, children: [
