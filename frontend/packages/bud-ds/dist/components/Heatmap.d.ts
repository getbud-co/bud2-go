...
export declare function Heatmap({ data, rows, columns, min: minProp, max: maxProp, color, showValues, formatValue, cellSize, labelWidth, gap, columnTooltips, className, }: HeatmapProps): import("react/jsx-runtime").JSX.Element;
